...
public class EmpController extends BaseController
{
     ...
     * 查询人员列表列表
     */
    @PreAuthorize("@ss.hasPermi('manger:emp:list')")
    @GetMapping("/list")
     ...
     * 导出人员列表列表
     */
    @PreAuthorize("@ss.hasPermi('manger:emp:export')")
     ...
     * 获取人员列表详细信息
     */
    @PreAuthorize("@ss.hasPermi('manger:emp:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增人员列表
     */
    @PreAuthorize("@ss.hasPermi('manger:emp:add')")
     ...
     * 修改人员列表
     */
    @PreAuthorize("@ss.hasPermi('manger:emp:edit')")
     ...
     * 删除人员列表
     */
    @PreAuthorize("@ss.hasPermi('manger:emp:remove')")
