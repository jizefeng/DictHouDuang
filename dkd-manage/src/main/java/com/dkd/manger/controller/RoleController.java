...
import com.dkd.manger.service.IRoleService;
...
public class RoleController extends BaseController
{
     ...
     * 查询角色管理列表
     */
    @PreAuthorize("@ss.hasPermi('manger:role:list')")
    @GetMapping("/list")
     ...
     * 导出角色管理列表
     */
    @PreAuthorize("@ss.hasPermi('manger:role:export')")
     ...
     * 获取角色管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('manger:role:query')")
     ...
     * 新增角色管理
     */
    @PreAuthorize("@ss.hasPermi('manger:role:add')")
     ...
     * 修改角色管理
     */
    @PreAuthorize("@ss.hasPermi('manger:role:edit')")
     ...
     * 删除角色管理
     */
    @PreAuthorize("@ss.hasPermi('manger:role:remove')")
