...
import com.dkd.manger.service.ITaskTypeService;
 ...
 */
@RestController
@RequestMapping("/manger/taskType")
public class TaskTypeController extends BaseController
{
     ...
     * 查询工单类型列表
     */
    @PreAuthorize("@ss.hasPermi('manger:taskType:list')")
    @GetMapping("/list")
     ...
     * 导出工单类型列表
     */
    @PreAuthorize("@ss.hasPermi('manger:taskType:export')")
     ...
     * 获取工单类型详细信息
     */
    @PreAuthorize("@ss.hasPermi('manger:taskType:query')")
     ...
     * 新增工单类型
     */
    @PreAuthorize("@ss.hasPermi('manger:taskType:add')")
     ...
     * 修改工单类型
     */
    @PreAuthorize("@ss.hasPermi('manger:taskType:edit')")
     ...
     * 删除工单类型
     */
    @PreAuthorize("@ss.hasPermi('manger:taskType:remove')")
