...
public class ChannelController extends BaseController
{
     ...
     * 查询售货机货道列表
     */
    @PreAuthorize("@ss.hasPermi('manger:channel:list')")
    @GetMapping("/list")
     ...
     * 导出售货机货道列表
     */
    @PreAuthorize("@ss.hasPermi('manger:channel:export')")
     ...
     * 获取售货机货道详细信息
     */
    @PreAuthorize("@ss.hasPermi('manger:channel:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增售货机货道
     */
    @PreAuthorize("@ss.hasPermi('manger:channel:add')")
     ...
     * 修改售货机货道
     */
    @PreAuthorize("@ss.hasPermi('manger:channel:edit')")
     ...
     * 删除售货机货道
     */
    @PreAuthorize("@ss.hasPermi('manger:channel:remove')")
